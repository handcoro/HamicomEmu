...
type ComponentProfileBenchmarks() =
    ...
    [<Benchmark(Description = "memRead x1000 (PPU range)")>]
    ...
    [<Benchmark(Description = "memWrite x1000 (PPU range)")>]
    ...
    [<Benchmark(Description = "memRead x1000 (RAM only)")>]
    ...
    [<Benchmark(Description = "Bus.tick x1000")>]
    ...
    [<Benchmark(Description = "Ppu.tickN x3000")>]
    ...
    [<Benchmark(Description = "Apu.tick x1000")>]
    ...
    [<Benchmark(Description = "Cpu.step x100")>]
    ...
    [<Benchmark(Description = "Ppu.writeToControlRegister x1000")>]
    ...
    [<Benchmark(Description = "memWrite x1 (PPU addr 0x2000)")>]
    member this.MemWritePpuSingle() =
        Bus.memWrite 0x2000us 0x80uy bus

    /// Bus.memRead を PPUアドレス 1回のみ
    [<Benchmark(Description = "memRead x1 (PPU addr 0x2002)")>]
    member this.MemReadPpuSingle() =
        Bus.memRead 0x2002us bus

    /// EmulatorCore.tick を 1000回実行の割り当て（完全な流れ）
    [<Benchmark(Description = "EmulatorCore.tick x1000")>]
